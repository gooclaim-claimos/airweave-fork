...
// Gooclaim-mode flag. When VITE_GOOCLAIM_MODE=true, the Gooclaim Sources
// fork renders as the Gooclaim Sources surface — wordmark, nav, and copy
// adapt per tasks/Review-Task/Gooclaim-Airweave-Sources/Frontend/. In
// open-source Airweave builds this stays false and the original UX is
// preserved.
